...
---
![](https://bucket.ziteh.dev/blog/unbox-zsa4itx/b411abd1.webp)
...
![這位賣家還滿用心的，我下單後有測試過沒問題才出貨的，好評一個!](https://bucket.ziteh.dev/blog/unbox-zsa4itx/4cace70f.webp)
...
![](https://bucket.ziteh.dev/blog/unbox-zsa4itx/33bb154d.webp)
...
![](https://bucket.ziteh.dev/blog/unbox-zsa4itx/a73b757c.webp)

![](https://bucket.ziteh.dev/blog/unbox-zsa4itx/c3fd254a.webp)
...
![這個包裝保護還滿扎實的，讚!](https://bucket.ziteh.dev/blog/unbox-zsa4itx/457deab6.webp)

![機殼本體是已經組裝好的樣子。](https://bucket.ziteh.dev/blog/unbox-zsa4itx/d2e92da4.webp)

![由左至右是電源線、其它配件和PCIe延長座，而下面那個應該是用來裝水冷排的固定架。](https://bucket.ziteh.dev/blog/unbox-zsa4itx/269ba51d.webp)

![上面説的其它配件内含這些物品。包含小3Pin風扇擴充線、2.5寸硬碟架(可以選擇要用2個盤位的的還是3個的)，各式螺絲4包。](https://bucket.ziteh.dev/blog/unbox-zsa4itx/dae98dc4.webp)

![](https://bucket.ziteh.dev/blog/unbox-zsa4itx/17f6ae5a.webp)

此機殼用的電源接頭是通常用在筆記型電腦充電器上的米奇頭(8字頭)，所以不能用一般電源供應器的線，而店家附的是中國用的插座，所以要再去買一條電源線來用。

![機殼上方的散熱孔有附這種PVC防塵網，至於兩側就沒有，可能之後自己去買來剪。](https://bucket.ziteh.dev/blog/unbox-zsa4itx/4593d389.webp)

# 零件換家

![](https://bucket.ziteh.dev/blog/unbox-zsa4itx/cc360dcc.webp)

首先當然要把舊零件拆下來。看看我之前的機殼：NZXT的Phantom 410，它依然是很帥氣的機殼，只是真的有些太大了。

組裝零件的過程因為我太笨手笨腳了，就忘記拍照片了。

![裝上CPU：i5-4460。用了超過5年還是非常夠用的。](https://bucket.ziteh.dev/blog/unbox-zsa4itx/ec262cff.webp)

![C7散熱器差點卡到電池。](https://bucket.ziteh.dev/blog/unbox-zsa4itx/c8cea4c0.webp)

![安裝好PSU、MB等零件。](https://bucket.ziteh.dev/blog/unbox-zsa4itx/99a3be64.webp)

![我的顯示卡長度約191mm，右側的空間都可以塞下3.5寸的HDD了。](https://bucket.ziteh.dev/blog/unbox-zsa4itx/bfcdc679.webp)

![接上電線後](https://bucket.ziteh.dev/blog/unbox-zsa4itx/4fcb4e75.webp)

![它上下的板子都是這種抽取式的設計。](https://bucket.ziteh.dev/blog/unbox-zsa4itx/fad0ec84.webp)

![開機按鈕](https://bucket.ziteh.dev/blog/unbox-zsa4itx/3316b346.webp)

![](https://bucket.ziteh.dev/blog/unbox-zsa4itx/80dff94f.webp)

![](https://bucket.ziteh.dev/blog/unbox-zsa4itx/d418d8e1.webp)

![](https://bucket.ziteh.dev/blog/unbox-zsa4itx/17e265c3.webp)
