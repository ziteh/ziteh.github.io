...
- [MyApollo](https://myapollo.com.tw/)：有很多網頁和 AI 技術的內容
- [Wiwi 官大為的貼文和筆記](https://wiwi.blog/)：官大為本身是鋼琴家，但是他可能比很多工程師還更*工程師*
- [小鍵盤展示間](https://small-keyboard.blogspot.com/)：有許多機械鍵盤
- [Interrupt](https://interrupt.memfault.com/)：有許多嵌入式和韌體相關的內容
- [Huli's blog](https://blog.huli.tw/)：有許多網頁前端和資安領域的內容
...
本網站所有內容除特別聲明外，均採用「[創用CC：姓名標示─非商業性─相同方式分享](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh-hant)」授權。  
